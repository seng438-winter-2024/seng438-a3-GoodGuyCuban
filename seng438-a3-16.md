...
| Data Flow  |  |
| -- | -- |
| defs: | def(1) = { data, column, total, rowCount } <br> def(2) = { r } <br> def(3) = { n } <br> def(5) = { r2 }  <br> def(6) = { n } |
| uses: | use(1) = { data } <br> use(2) = { r, rowCount } <br> use(3) = { data, r, column } <br> use(4) = { total, n } <br> use(5) = { r2, rowCount } <br> use(6) = { data, r2, column } <br> use(7) = { total, n } <br> use(8) = { total } |
| du-pairs: | for data  (1,1) (1,3) (1,6) <br> for column  (1,3) (1,6) <br> for total  (1,4) (1,7) (1,8) <br> for rowCount (1,2) (1,5)  <br> for r (2,2) (2,3) <br> for r2 (5,5) (5,6) <br> for n (3,4) (6,7) |

### Pairs Covered by Test Cases:

| Test Case | DU-Pairs Covered |
| -- | -- |
| all* | data  (1,1) <br> for total (1,8) <br> for rowCount (1,2) (1,5)  <br> for r (2,2) <br> for r2 (5,5) |

### DU-Pair Coverage:
```
du-pair coverage = (? / 16) * 100 = ???%
```
